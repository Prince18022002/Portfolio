      ...
      <header className='w-full px-32 py-8 font-medium flex item-center justify-between dark:text-light relative'>
       ...
       <div className="w-full flex justify-between items-center lg:hidden">
        ...
        <nav className="flex items-centre justify-centre flex-wrap">
          <motion.a href="https://twitter.com/Princewebdev1" target={"_blank"}
          whileHover={{y:-2}}
          whileTap={{scale:0.9}}
          className="w-6 mr-3"
          >
          ...
          <motion.a href="https://github.com/Prince18022002" target={"_blank"}
          whileHover={{y:-2}}
          whileTap={{scale:0.9}}
          className="w-6 mx-3">
            <GithubIcon />
          </motion.a>
          <motion.a href="https://www.linkedin.com/in/prince-gupta-a5a778229/" target={"_blank"}
          whileHover={{y:-2}}
          whileTap={{scale:0.9}}
          className="w-6 mx-3">
            <LinkedInIcon />
          </motion.a>
          <motion.a href="https://in.pinterest.com/princeguptarockz/" target={"_blank"}
          whileHover={{y:-2}}
          whileTap={{scale:0.9}}className="w-6 mx-3">
            <PinterestIcon />
          </motion.a>
          <motion.a href="https://www.instagram.com/prince_gupta9651/" target={"_blank"}
          whileHover={{y:-2}}
          whileTap={{scale:0.9}}
          className="w-6 ml-3">
            < InstagramIcon/>
