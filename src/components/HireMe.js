...
const HireMe = () => {
  return (
    ...
    flext items- centre justify-center overflow-hidden'>
    <div className='w-48 h-auto flex items-centre justify-center relative'>
        <CircularText className={"fill-dark animate-spin-slow dark:fill-light"}/>
      <Link href="mailto:princeguptaims@gmail.com" className='flex items-center justify-center
